        ...
        <div class="row">
            ...
            <div class="card-style mb-30">
                ...
                <form action="{{ route("blog.store") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-style-1">
                    <label>Content</label>
                    <textarea placeholder="Content..." id="myRichTextbox" rows="5"></textarea>
                    </div>
                    @if (auth()->user()->is_superuser)
                    <div class="select-style-1">
                    <label>Status</label>
                    <div class="select-position">
                        <select name="status" disabled class=" bg-black color-white">
                    ...
                    <div class="text-center">
                        <button type="submit" class="main-btn primary-btn rounded-full btn-hover">Post</button>
                    </div>
                </form>
                </div>
            </div>
